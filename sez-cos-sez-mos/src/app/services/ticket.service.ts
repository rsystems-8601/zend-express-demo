...
import {Member, MemberReference, Ticket, TicketDetails, TicketPriority} from "../models/ticket.model";
...
export class TicketService extends RESTAuthClient {
    ...
    uploadAttachment(@Path("ticketId") ticketId: number, @FileUpload file: File): Observable<void> {
        return null;
    }
