...
export class PrivatevlansService extends RESTAuthClient {
    ...
    @DELETE("cosmos-portal/vlan/delete/{pvlanId}")
    //@ErrorHandler("delete-user")
    deletePrivatevlan(@Path("pvlanId") pvlanId: number): Observable<PrivatevlanCreate> {
        return null;
    }
