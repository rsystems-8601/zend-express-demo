...
import { CategoryCreateUpdateRequest, CategoryService} from "../../../services/category.service";
import { Category } from "../../../../../models/category.model";

@Component({
    templateUrl: "./cos-edit-public-vlan.component.html"})

export class CosEditPublicvlanComponent {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public category: Category,
                public dialogRef: MatDialogRef<CosEditPublicvlanComponent>,
